...
if ($_SERVER["REQUEST_METHOD"] == "POST" && $_REQUEST["register_submit_button"] <> '' && !$USER->IsAuthorized())
{
	...
	// Установка дефолтного значения для пользовательского поля UF_POINTS
	if (!isset($arResult["VALUES"]["UF_POINTS"]))
	{
		$arResult["VALUES"]["UF_POINTS"] = 1000; // дефолтное значение 1000
	}
